...
import { X, Check, CircleArrowLeft } from 'lucide-react';
    ...
    <>
      <div className="container mx-auto px-8 py-8 max-w-7xl">
        ...
        <div className="flex gap-10">
            ...
            {!state.userInput.userName || !state.userInput.job_name ? (
              <form onSubmit={handleSubmit} >
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    type="submit"
                    className={`w-20 bg-blue-900 text-white py-1 rounded-md hover:bg-blue-700 transition-all transform hover:scale-[1.02] active:scale-[0.98] ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
                      }`}
          ...
          <div>
            <h4 className="font-medium mb-4 text-blue-900 text-2xl font-bold">已記錄的日期與內容</h4>
